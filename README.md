...
\* \*\*Intrinsics-Based Tail Measurements\*\*: Benchmarked with High-Precision `\_\_rdtsc` cycle calibration to measure strict microsecond tail latencies.
...
\*Executed on x86-64 CPU (2496 MHz) calibrated with `\_\_rdtsc` cycles:\*
